...
import { ref } from "vue";
import { useAnniversary } from "./utils/hook";
...
<template>
  <div>
    ...
    <PureTableBar title="纪念日" :columns="columns" @refresh="onSearch">
      <template #buttons>
        <el-button
          v-if="hasPerms('admin:anniversary:insert')"
          type="primary"
